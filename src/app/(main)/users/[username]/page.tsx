...
const Page: React.FC<PageProps> = async ({ params: { username } }) => {
    ...
    if (!loggedInUser) {
        return (
            <p className='text-destructive'>You&apos;re not authorized to view this page</p>
        );
    }
...
export const UserProfile: React.FC<UserProfileProps> = async ({ user, loggedInUserId }) => {
            ...
            <div className='flex flex-wrap gap-3 sm:flex-nowrap'>
                <div className='me-auto space-y-3'>
                    <div>
                        ...
                        <div>Member since {formatDate(user.createdAt, "MMM e, yyyy")}</div>
